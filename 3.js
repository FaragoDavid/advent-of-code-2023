const input = `...................15....904...........850.................329...................13....................................871....816....697....
...
const hasSpecChar = (str) => !!/[%*#&$@\/=+-]/.exec(str);
function part1(input) {
  ...
  input.split`\n`.forEach((row, rowIndex, rows) => {
    [...row.matchAll(/[0-9]+/g)].map(({ 0: num, index }) => {
      ...
      if (
        hasSpecChar(row.slice(segmentStart, segmentEnd)) ||
        (rowIndex > 0 &&
          hasSpecChar(rows[rowIndex - 1].slice(segmentStart, segmentEnd))) ||
...
console.log("Part 1 expected:", 4361, "actual:", part1(example));
...
function part2(input) {
  ...
  return Object.values(gears).reduce((total, values) => {
    if (values.length === 2) return total + values[0] * values[1];
    return total;
  }, 0);
}

console.log("Part 2 expected:", 467835, "actual: ", part2(example));
